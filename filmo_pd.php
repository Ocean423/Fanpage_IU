...
<div class="all w3-container">
    ...
    <div class="content w3-center" style="width: 100%">
        <h1 class="albumTitle" style="font-family: Staatliches">신디</h1>
    </div>
    
    <div class="albumInfo">
        <h3>INFOMATION</h3>
        <p>예능국 안에서 펼쳐지는 이야기</p>
    </div>
    
    <div class="albumInfo">
        <h3>CAST</h3>
        <p> 신디 (23세) <br>
            13살 때 연습생으로 변엔터에 들어간 10년 차 연예인. <br>
            세상에 절대 공짜는 없고 이 바닥이 얼핏 화려해 보이지만, <br>
            차가워서 편안히 몸 누일 바닥이 절대 아니라는 걸 열다섯 되기 전에 깨달았다.</p>
    </div>
